// Query helpers for table: programme_vaccination
import { makeCrud } from './_base.js';

const crud = makeCrud('programme_vaccination');

export const programmeVaccinationApi = {
  // --- generic CRUD ---
...
export default programmeVaccinationApi;
