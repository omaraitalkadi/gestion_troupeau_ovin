// Query helpers for table: transaction_animaux
import { makeCrud } from './_base.js';

const crud = makeCrud('transaction_animaux');

export const transactionAnimauxApi = {
  // --- generic CRUD ---
...
export default transactionAnimauxApi;
