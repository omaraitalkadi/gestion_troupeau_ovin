// Query helpers for table: historique_modification
import { makeCrud } from './_base.js';

const crud = makeCrud('historique_modification');

export const historiqueModificationApi = {
  // --- generic CRUD ---
...
export default historiqueModificationApi;
